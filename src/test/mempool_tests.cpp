...
BOOST_AUTO_TEST_CASE(MempoolSizeLimitTest)
{
    ...
    BOOST_CHECK(pool.exists2(tx1.GetHash()));
    BOOST_CHECK(pool.exists2(tx2.GetHash()));
    ...
    BOOST_CHECK(!pool.exists2(tx1.GetHash()));
    BOOST_CHECK(pool.exists2(tx2.GetHash()));
    BOOST_CHECK(pool.exists2(tx3.GetHash()));
    ...
    BOOST_CHECK(pool.exists2(tx4.GetHash()));
    BOOST_CHECK(pool.exists2(tx6.GetHash()));
    BOOST_CHECK(!pool.exists2(tx7.GetHash()));

    if (!pool.exists2(tx5.GetHash()))
        AddToMempool(pool, entry.Fee(1000LL).FromTx(tx5));
    AddToMempool(pool, entry.Fee(9000LL).FromTx(tx7));

    pool.TrimToSize(pool.DynamicMemoryUsage() / 2); // should maximize mempool size by only removing 5/7
    BOOST_CHECK(pool.exists2(tx4.GetHash()));
    BOOST_CHECK(!pool.exists2(tx5.GetHash()));
    BOOST_CHECK(pool.exists2(tx6.GetHash()));
    BOOST_CHECK(!pool.exists2(tx7.GetHash()));
