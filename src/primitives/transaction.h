...
private:
    ...
    // Private constructors for the factory methods
    explicit GenTxid(const ::Txid& txid) : m_is_wtxid(false), m_txid(txid) {}
    explicit GenTxid(const ::Wtxid& wtxid) : m_is_wtxid(true), m_wtxid(wtxid) {}
